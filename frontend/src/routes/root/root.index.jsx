    ...
    <main>
      <section className="mb-16 flex flex-col">
        ...
        <h2
          ...
          font-sans text-6xl font-semibold leading-[1.10] tracking-tighter xs:mt-36 xs:text-7xl
          sm:mt-44 sm:text-8xl md:text-8xl lg:mt-28 xl:mt-20
          xl:text-7xl 3xl:text-9xl 4xl:mt-60 4xl:text-[12rem]"
        >
          Planning your week has never been easier.
        </h2>
        <p
          className="mx-8 text-center font-sans text-3xl font-light
          tracking-tight text-slate-700 xs:text-3xl md:text-4xl xl:text-3xl 2xl:text-4xl
