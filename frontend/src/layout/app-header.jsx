...
export function AppHeader({ header, appLogo, appName, githubLogo }) {
  return (
    <header
      className={`align-center mx-8 my-8 flex items-center justify-between
      4xl:mx-24 4xl:my-20 ${header}`}
    >
      <Link to={`/`} className="flex">
        <AppLogo
          classes={`w-10 h-10 select-none mr-1 3xl:w-20
          3xl:h-20 4xl:w-32 4xl:h-32 stroke-rose-500 ${appLogo}`}
        />
        <h2
          to={`/`}
