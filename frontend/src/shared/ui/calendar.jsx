  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        hover:text-slate-50 focus:bg-slate-900 focus:text-slate-50
        dark:bg-slate-50 dark:text-slate-900 dark:hover:bg-slate-50
        dark:hover:text-slate-900 dark:focus:bg-slate-50
        dark:focus:text-slate-900`,
        day_today: `bg-slate-100 text-slate-900 dark:bg-slate-800
        dark:text-slate-50`,
        day_outside: "text-slate-500 opacity-50 dark:text-slate-400",
        day_disabled: "text-slate-500 opacity-50 dark:text-slate-400",
        day_range_middle: `aria-selected:bg-slate-100
        aria-selected:text-slate-900 dark:aria-selected:bg-slate-800
