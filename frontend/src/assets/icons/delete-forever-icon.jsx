...
export function DeleteForeverIcon({ className }) {
  return (
    <svg
    ...
    >
      <path
        d="m376-300 104-104 104 104 56-56-104-104 104-104-56-56-104
        104-104-104-56 56 104 104-104 104 56 56Zm-96 180q-33
